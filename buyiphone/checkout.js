(function () {
  ...
  window.emperorishopOpenCheckout = function () {
    showError("");
    var snap = window.emperorishopBuyiPhone && window.emperorishopBuyiPhone.getOrderSnapshot();
    if (!snap) {
      return;
    }
    pendingSnap = snap;
  ...
  if (form) {
    ...
    form.addEventListener("submit", function (e) {
      e.preventDefault();
      var snap = pendingSnap || (window.emperorishopBuyiPhone && window.emperorishopBuyiPhone.getOrderSnapshot());
      if (!snap) return;
